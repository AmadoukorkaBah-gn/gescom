...
<style>
    ...
    #caisseEditPage input {
        font-family: inherit;
    }
</style>


<div id="caisseEditPage"
    ...
    <div class="max-w-2xl mx-auto">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-sm sm:text-base
                        ...
                        Modifiez les informations de cette caisse.
        ...
        {{-- =====================================================
             FORMULAIRE
        ====================================================== --}}
        <form action="{{ route('caisses.update', $caisse) }}"
              method="POST"
              class="bg-white
            ...
            <div class="bg-blue-50
                ...
                <p class="text-xs sm:text-sm
                    ...
                    Vous pouvez modifier le nom et le solde de la caisse.
