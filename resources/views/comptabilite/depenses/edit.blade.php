...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-lg mx-auto">
        <h1 class="text-2xl font-bold text-gray-800 mb-6">Modifier la Dépense</h1>
        ...
        <form action="{{ route('depenses.update', $depense->id) }}" method="POST" class="bg-white shadow-md rounded-lg p-6">
            @csrf
            @method('PUT')
            ...
            <div class="mb-4">
                ...
                <input type="number" name="montant" step="0.01" min="0.01" value="{{ old('montant', $depense->montant) }}" 
            ...
            <div class="mb-4">
                ...
                <input type="date" name="date_depense" value="{{ old('date_depense', $depense->date_depense->format('Y-m-d')) }}" 
            ...
            <div class="mb-4">
                ...
                <select name="caisse_id" class="form-select w-full border rounded px-3 py-2 @error('caisse_id') border-red-500 @enderror" required>
                    @foreach($caisses as $caisse)
                        <option value="{{ $caisse->id }}" {{ old('caisse_id', $depense->caisse_id) == $caisse->id ? 'selected' : '' }}>
